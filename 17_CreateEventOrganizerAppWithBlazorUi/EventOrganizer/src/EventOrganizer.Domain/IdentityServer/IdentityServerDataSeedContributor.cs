...
public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApiResourcesAsync()
    {
        ...
        await CreateApiResourceAsync("EventOrganizer", commonApiUserClaims);
    }
    ...
    private async Task CreateClientsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["EventOrganizer_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["EventOrganizer_App:RootUrl"]?.TrimEnd('/');
        ...
        // Blazor Client
        var blazorClientId = configurationSection["EventOrganizer_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["EventOrganizer_Blazor:RootUrl"].TrimEnd('/');
